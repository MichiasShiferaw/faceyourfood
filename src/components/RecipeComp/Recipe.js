...
<section className="p-0">
  ...
  <ol className="breadcrumb">
    <Link to='/categories' className="breadcrumb-item">{t("categories")}</Link>
    <Link to={`/categories/${currRecipe.category}`} className="breadcrumb-item">{(currRecipe.category).charAt(0).toUpperCase() + (currRecipe.category).slice(1)}</Link>
    {/* <li className="breadcrumb-item" data-bs-toggle="modal" data-bs-target="#exampleModal"><a href="#/">Muffins</a></li> */}
    <li className="breadcrumb-item active" aria-current="page">{currRecipe.name}</li>
 ...
 <h1 className="display-4 recipeheader"><strong>{currRecipe.name}</strong>
          ...
          <div className="d-flex justify-content-between">
            <div>
              <h1 className="display-4 recipeheader text-grite">
                <strong>{currRecipe.name}</strong>
              </h1>
            </div>
            <div>
              <span>
                <Toggle className="pe-3 display-4" icon={"bi bi-heart"} />{" "}
              </span>
              <a href="#0">
                <i className="bi bi-download text-forgreen px-3 display-4"></i>
              </a>
              <span>{stars(currRecipe.rating)}</span>
            </div>
          </div>
        ...
        <div className="row mt-0 mt-md-5">
          ...
          <div className="col-md-6">
            <div id='ingredients'className="ingredientssect mt-4 mt-md-5 bg-secondary bg-opacity-25">
              <h3 className="ps-2"><strong>{t("ingredients")}</strong></h3>
  ...
  <tbody>
    ...
    <tr>
            ...
            <div className="mt-5">
              ...
              <ul id='instructions' className="instruction-list list-unstyled ps-0 mt-5">
                <li className="d-flex align-items-start text-align-start">
                  ...
                  <span className="badge bg-forgreen rounded-pill mx-5">1</span>
                 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">2</span>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">3</span>
                                   Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">4</span>
                                   Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">5</span>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">6</span>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start text-align-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">7</span>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex  text-align-start align-items-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">8</span>
                                   Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
                <li className="d-flex align-items-start">
                  <span className="badge bg-forgreen rounded-pill mx-5">9</span>
                                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                </li>
              </ul>
            </div>
      ...
      <div className="feedback my-0 my-md-5 py-1 py-md-5 text-center">
        ...
        <a href="#reviewtitle" className="btn btn-outline-dark my-2 py-2 px-5">{t("shareFeedback")}</a>
        <br/>
        <br/>
        <hr className="lh-lg"/>
      </div>
