...
<br/> 
      ...
      {/* </div> */}
        ...
        <div className="col-lg-3 col-4">
          <a href="#0" className="btn btn-lg btn-primary px-4 px-md-5 bg-forgreen text-uppercase">{t("save")}</a>
        </div>
      </div>
      ...
      <div className="row align-items-center text-grite">
        <div className="col-lg-5 text-center ">
          <h4 className="mb-5">{t("changeAvatar")}</h4>
          <div className="d-flex">
          <input className="h7" type="file" onChange={handleChange}/>
        <button className="btn btn-secondary fw-bold" disabled={loading ||!photo}>{t("upload")}</button>
        </div>
        </div>
...
<label htmlFor="email" className="form-label">{t("emailAddress")}:</label>
              ...
              <div className="col-sm-6">
                <div className="form-group custom-form-group">
                    <label htmlFor="email" className="form-label">{t("password")}:</label>
                        <div className="mb-4 input-group">
                            <span className="input-group-text">
            ...
            <div className="mt-3 mt-md-5 pt-2 pt-md-4 pb-1">
              <h3 className="text-center mb-3 mb-md-5">{t("connect")}</h3>
            ...
            <div className="mt-3 mt-md-5">
              <h3 className="f-size-20 mb-2 mb-md-4 pb-2">{t("newsletter")}</h3>
              <div className="d-md-flex text-center">
                <img src="/assets/images/chef.gif" height={"90px"} alt="Cooking" />
                <h5 className="mb-3">{t("currently")} <strong>{t("subscribed")}</strong> {t("newsletter1")}</h5>
                <div className="ms-auto mb-3">
                  <a href="#0" className="btn btn-lg btn-outline-dark mx-2 px-4 px-md-5">{t("unsubscribe")}</a>
                </div>
              </div>
            </div>
