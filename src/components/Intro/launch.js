...
<div className="container p-0 ">          <div className="row row-cols-auto">
            <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">30 mins</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Carb-free</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Vegan</div>
...
<div className="container p-0 ">          <div className="row row-cols-auto">
            <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">30 mins</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Carb-free</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Egg-free</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Tag: 4</div>
...
<div className="container p-0 ">          <div className="row row-cols-auto">
    ...
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Carb-free</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Egg-free</div>
    <div className="bg-darkturq text-beige2 rounded-pill m-1 p-2 d-inline-block search-item">Tag4</div>
