...
function About() {
  return (
      ...
      <div className="container-fluid py-5">
        ...
        <button className="btn btn-primary btn-lg" type="button">Check Out My Github</button>
        </div><div>
    ...
    <div className="row align-items-md-stretch">
      <div className="col-md-6">
        <div className="h-100 p-5 text-white bg-dark rounded-3">
          <h2>FYF Mission</h2>
          <p>This website is strictly to demonstrate my knowledge in React through heurtistic and interactive processes</p>
          <button className="btn btn-outline-light" type="button">FYF Mission</button>
        </div>
      </div>
      <div className="col-md-6">
        <div className="h-100 p-5 bg-light border rounded-3">
          <h2>Contact Us</h2>
          <p><ul className="list-unstyled fs-4">
        ...
        <li>FAX: <i>253-561-5432</i></li>
          ...
          <button className="btn btn-outline-secondary" type="button">Email US</button>
        </div>
      </div>
    </div></div>
  )
